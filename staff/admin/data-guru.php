  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <img src="../asset/img/hogwart.png" style="width: 40px; height: 40px;">
        </div>
        <div class="sidebar-brand-text mx-3">Exam Online</div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Kelola Data Guru</h1>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?= $gr['username']; ?></td>
                      <td>
                        <a href="hapus-guru.php?id=<?= $gr['id_staff'];?>"onclick="return confirm('Anda yakinn ingin menghapusnya ?');"><span class="icon-trash"></span></a><span>&nbsp;</span>
                    </tr>
                  </tbody>
                  <?php $x; ?>
                <?php endforeach; ?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Web Programming Riefyan <?= date('Y');?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
