...
<div class="container">
      <div class="row">
       <div class="col-md-8 offset-md-2">
            ...
            <div class="panel-heading col-sm-12 "  style="background-color: rgba(255,255,255,.7); font-family: system-ui;"><h3 class="text-center" style="color: black; padding-left: px  "><i class="icon-user"></i>Tambah Data Siswa</h3></div> 
              ...
              <form method="POST">
                ...
                <div class="form-group col-md-8 offset-md-2">
                	<input type="text" name="NIS" placeholder="Masukkan NIS" class="form-control" required="" autocomplete="off">
                </div>
                ...
                <div class="col-md-6 offset-md-3 form-group">
                	<button class="form-control btn btn-success" name="tambah" type="submit" style="border-radius: 50px">Tambah</button>
                </div>	
