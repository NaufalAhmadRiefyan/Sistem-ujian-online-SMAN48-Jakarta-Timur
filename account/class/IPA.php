...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12" style="padding-left: 0%; ">
          <br><br>
          <p class="size: 2px;">&nbsp;&nbsp;&nbsp;<b>Select Class </b>
            <hr style="width: 150px; border-color: black; border-top: 2px solid black; margin-left: 10px;">
          </p>

          <div class="dropdown">
            &nbsp;&nbsp;&nbsp;<a data-toggle="dropdown" title="Pilih Kelas" href="" style="color: #000; size: 20px;"><i class="icon-th-list"></i></a>
            <div class="dropdown-menu ">
              <a href="<?php echo 'IPA.php?q=10'; ?>" class="dropdown-item">10-IPA</a>
              <a href="<?php echo 'IPA.php?q=11'; ?>" class="dropdown-item">11-IPA</a>
              <a href="<?php echo 'IPA.php?q=12'; ?>" class="dropdown-item">12-IPA</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="list" id="list">
       ...
       <div class="col-md">
         <div class="pagination">'; ?>
            <?php if ($HalamanAktif > 1) : ?>
              <ul class="pagination">
                <li class="page-item"><a class="page-link" href="?q=10&halaman=<?= $HalamanAktif - 1; ?>">Previous</a></li>
              </ul>
            <?php endif; ?>
    ...
    <?php
      $result = mysqli_query($conn, "SELECT * FROM ujian WHERE kelas = '10 IPA-1' OR kelas = '10 IPA-2' OR kelas = '10 IPA-3' ORDER BY kelas ASC LIMIT $awalData, $jumlahDataPerHalaman ") or die("Error 1");
      echo '<div class="container tabel" style="overflow-x:auto;"><div class="row"><div class="col"><table class="table table-hover">
               <thead class="thead">
    ...
    if (@$_GET['q'] == 11) {
      ...
      <?php if ($HalamanAktif > 1) : ?>
        <ul class="pagination">
          <li class="page-item"><a class="page-link" href="?q=11&halaman=<?= $HalamanAktif - 1; ?>">Previous</a></li>
        </ul>
      <?php endif; ?>
      <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
        <?php if ($i == $HalamanAktif) : ?>
          <ul class="pagination">
            <li class="page-item active"><a class="page-link" href="?q=11&halaman=<?= $i; ?>"><?= $i; ?></a></li>
          </ul>
        <?php else : ?>
          <li class="page-item"><a class="page-link" href="?q=11&halaman=<?= $i; ?>"><?= $i; ?></a></li>
        <?php endif; ?>
      <?php endfor; ?>

      <?php if ($HalamanAktif < $jumlahHalaman) : ?>
        <li class="page-item"><a class="page-link" href="?q=11&halaman=<?= $HalamanAktif + 1; ?>">Next</a></li>
        </ul>
      <?php endif; ?>
  ...
  <?php
    $result = mysqli_query($conn, "SELECT * FROM ujian WHERE kelas = '11 IPA-1' OR kelas = '11 IPA-2' OR kelas = '11 IPA-3' ORDER BY kelas ASC LIMIT $awalData ,$jumlahDataPerHalaman ") or die("Error 1");
  ...
  if (@$_GET['q'] == 12) {
    ...
    <?php if ($HalamanAktif > 1) : ?>
      <ul class="pagination">
        <li class="page-item"><a class="page-link" href="?q=12&halaman=<?= $HalamanAktif - 1; ?>">Previous</a></li>
      </ul>
    <?php endif; ?>
    <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
      <?php if ($i == $HalamanAktif) : ?>
        <ul class="pagination">
          <li class="page-item active"><a class="page-link" href="?q=12&halaman=<?= $i; ?>"><?= $i; ?></a></li>
        </ul>
      <?php else : ?>
        <li class="page-item"><a class="page-link" href="?q=12&halaman=<?= $i; ?>"><?= $i; ?></a></li>
      <?php endif; ?>
    <?php endfor; ?>

    <?php if ($HalamanAktif < $jumlahHalaman) : ?>
      <li class="page-item"><a class="page-link" href="?q=12&halaman=<?= $HalamanAktif + 1; ?>">Next</a></li>
      </ul>
    <?php endif; ?>
  ...
  <?php
    $result = mysqli_query($conn, "SELECT * FROM ujian WHERE kelas = '12 IPA-1' OR kelas = '12 IPA-2' OR kelas = '12 IPA-3' ORDER BY kelas ASC LIMIT $awalData,$jumlahDataPerHalaman") or die("Error 1");
    echo '<div class="container tabel" style="overflow-x:auto;"><div class="row"><div class="col"><table class="table">
               <thead class="thead">
                <tr><th>No.</th><th>Mata Pelajaran</th><th>Kelas</th><th>Opsi</th></tr></thead>';
    $x = 1;
